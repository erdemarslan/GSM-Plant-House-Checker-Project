...
// Sabitler
const String TelNo PROGMEM = "+905*********";
const String API_TOKEN PROGMEM = "ERA-BIHO-0001-TR";
const String API_ID PROGMEM = "35150400*******"; // Cihazın imei ve ya mac numarası yazılabilir! Önceden alınırsa programa ek yük bindirmez
